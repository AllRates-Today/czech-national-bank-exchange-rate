# Czech National Bank Exchange Rate API — czech-national-bank-exchange-rate
...
Also published under the org scope as [`@allratestoday/czech-national-bank-exchange-rate`](https://www.npmjs.com/package/@allratestoday/czech-national-bank-exchange-rate) — same code, same versions.
